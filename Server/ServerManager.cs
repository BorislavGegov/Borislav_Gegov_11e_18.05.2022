...
namespace Server
{
    public static class ServerManager
    {
        ...
        private static Dictionary<Type, object> RecieveMessage(BinaryMessage binaryMessage)
        {
            ...
            {
                Subject message = obj as Subject;

                return new Dictionary<Type, object>()
                {
                    { typeof(Subject), message }
                };
            }
            ...
            else if (obj is List<Subject>)
            {
                List<Subject> subjects = obj as List<Subject>;

                return new Dictionary<Type, object>()
                {
                    { typeof(List<Subject>), subjects }
                };
            }
            else
            {
        ...
        public static bool ContinueListening()
        {
            ...
            {
                Console.WriteLine("I said Y or N? [y/Y or n/N]");
